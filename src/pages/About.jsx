...
const About = () => {
  ...
  const inputCls = "w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 placeholder:text-gray-300 focus:outline-none focus:border-purple-400 focus:bg-purple-50 transition-all";
  ...
  return (
    <div className="bg-white">
      ...
      {/* ── HERO ── */}
      <section className="relative text-center px-6 py-20 overflow-hidden border-b border-gray-200">
        <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_80%_50%_at_50%_-10%,rgba(139,92,246,0.06)_0%,transparent_70%)]" />
        <div className="relative max-w-[600px] mx-auto">
          <p className="text-[11px] font-medium tracking-[1.5px] uppercase text-gray-400 mb-3">
            About Us
          </p>
          <h1 className="text-3xl sm:text-[48px] font-medium text-gray-900 tracking-[-1.5px] leading-[1.1] mb-4">
      ...
      <section className="max-w-[1000px] mx-auto px-6 py-16 sm:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {values.map((val, i) => (
            <div key={i} className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-purple-300 hover:shadow-sm transition-all shadow-sm">
              <div className="w-10 h-10 rounded-xl bg-purple-50 border border-purple-100 flex items-center justify-center text-lg mb-4">
                {val.icon}
              </div>
              <p className="text-[15px] font-medium text-gray-900 mb-2">{val.title}</p>
      ...
      <section className="max-w-[700px] mx-auto px-6 py-16 sm:py-20">
        ...
        <h2 className="text-2xl sm:text-[36px] font-medium text-gray-900 tracking-[-0.8px] text-center mb-8">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-sm">
          ...
          <div className="flex items-center gap-3 mt-6 pt-6 border-t border-gray-200">
            <div className="w-9 h-9 rounded-full bg-purple-100 flex items-center justify-center text-sm font-medium text-purple-600">
              NRR
            </div>
            <div>
              <p className="text-sm font-medium text-gray-800">Naymur Rahman Riyad</p>
              <p className="text-xs text-gray-400">Founder, CareerCoach</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1000px] mx-auto px-6 py-16 sm:py-20">
        ...
        <h2 className="text-2xl sm:text-[36px] font-medium text-gray-900 tracking-[-0.8px] text-center mb-12">
          Who Built This
        </h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-[600px] mx-auto">
          {team.map((member, i) => (
            <div key={i} className="bg-white border border-gray-200 rounded-2xl p-6 text-center shadow-sm hover:border-purple-300 hover:shadow-md transition-all">
              <div className="w-14 h-14 rounded-2xl bg-purple-50 border border-purple-100 flex items-center justify-center text-lg font-medium text-purple-600 mx-auto mb-4">
                {member.initials}
              </div>
              <p className="text-[15px] font-medium text-gray-900 mb-1">{member.name}</p>
      ...
      <section className="max-w-[700px] mx-auto px-6 py-16 sm:py-20" id="contact">
        ...
        <p className="text-sm text-gray-500 text-center max-w-md mx-auto mb-10 leading-relaxed">
          ...
          {success ? (
            <div className="text-center py-8">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-xl text-sm text-gray-500 border border-gray-200 hover:text-purple-600 hover:border-purple-300 hover:bg-purple-50 transition-all"
              >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="py-3.5 rounded-xl text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-cyan-600 hover:opacity-90 transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-md shadow-purple-200"
              >
